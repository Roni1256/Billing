...
const App = () => {
  ...
  const getCurrentUser=async()=>{
    setLoading(true)
    await axios.get(API_URLS.presentuser+localStorage.getItem('token'))
    .then((res)=>{setData(res.data);setAuth(true)})
      ...
      <Routes>
        {!isAuth &&
            <>
              ...
              <Route path="/auth" element={<Auth user={setData}  isAuth={isAuth} setAuth={setAuth} isLoading={isLoading} />} />
            </>
        }

        {isAuth &&  <>
            <Route path='/create-template' element={<CreateTemplate updates={getCurrentUser}  />} >
            </Route>
            <Route path='/dashboard' element={<Dashboard data={userData} isLoading={isLoading} isAuth={isAuth} setAuth={setAuth} />}>
              <Route path='' element={<Profile data={userData} isLoading={isLoading} updates={getCurrentUser}/>} />
