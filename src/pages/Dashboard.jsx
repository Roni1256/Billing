          ...
          <div className="w-full max-w-7xl mx-auto">
            <div className="flex items-center justify-between gap-4 mb-6">
              <div className="flex items-center justify-between w-full gap-3">
                ...
                <button
                  className="z-10 flex items-center justify-start p-2 md:p-3 hover:bg-slate-200 dark:hover:bg-gray-700 rounded-lg transition-colors md:hidden"
              ...
              <div className="flex items-center gap-2 md:gap-5">
                <button
                  className="flex items-center justify-start p-1.5 md:p-3 hover:bg-slate-200 dark:hover:bg-gray-700 rounded-lg transition-colors"
